    ...
    <div className="bg-white/30 backdrop-blur-[12px] border border-white/20 rounded-3xl p-5 flex flex-col gap-3 shadow-[0_8px_32px_0_rgba(120,85,94,0.08)]">
      ...
      {isAnalyzing ? (
        ...
        <button
          ...
          className="w-full h-14 bg-primary text-white font-gowun text-base font-semibold rounded-full shadow-lg disabled:opacity-40 disabled:cursor-not-allowed hover:scale-[0.98] active:scale-95 transition-all duration-300 flex items-center justify-center gap-2"
        >
