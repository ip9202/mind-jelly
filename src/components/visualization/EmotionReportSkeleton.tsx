...
export function EmotionReportSkeleton() {
  return (
    <div
      className="glass-card rounded-3xl px-5 py-4 bg-white/10 backdrop-blur-md border border-white/20"
      aria-busy="true"
    ...
    >
      ...
      <div className="mb-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="h-48 bg-gray-100 rounded-xl animate-pulse" aria-hidden="true" />
          <div className="h-48 bg-gray-100 rounded-xl animate-pulse" aria-hidden="true" />
        </div>
      </div>
